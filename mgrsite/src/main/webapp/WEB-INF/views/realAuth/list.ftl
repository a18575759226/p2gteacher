				...
				<form id="searchForm" class="form-inline" method="post"
					...
					<div class="form-group">
						<label>申请时间</label> <input class="form-control" type="text"
							...
							value="${(qo.beginDate?string('yyyy-MM-dd'))!''}" />到 <input
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								...
								<td><#if (info.state == 0)> <a href="javascript:void(-1);"
									class="auditClass" data-json='${info.jsonString}'>审核</a> </#if>
								</td>
							</tr>
							</#list>
						</tbody>
